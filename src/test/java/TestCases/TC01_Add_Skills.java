...
public class TC01_Add_Skills
{
	...
	@Test
	public void Test1_Skills(String Skills) throws Exception {
		...
		String Skills1= Datatable.get("TC02").get("Skills");
		...
		Skills N1= new Skills();
		N1.Skills(driver,TestScriptName,logger,extent);
		N1.AddSkills(Skills1);
