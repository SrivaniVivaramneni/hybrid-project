...
{
	private static final String Jobs = null;
	...
	@Test
	public void Test1_Jobs() throws Exception {
		...
		String Jobs= Datatable.get("TC03").get("Jobs Titles");
		...
		Jobs N1= new Jobs();
		N1.Jobs(driver,TestScriptName,logger,extent);
		N1.AddJobs(Jobs);
